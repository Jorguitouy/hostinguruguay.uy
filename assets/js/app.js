...
(function ($) {
  ...
  // (Fuentes) Se cargan desde etiqueta <link> en HTML para optimizar el rendimiento.
  ...
  // 8. magnify popup video (carga condicional para evitar errores si no está el plugin)
